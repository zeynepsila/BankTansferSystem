    ...
    protected function createController()
{
    ...
    if (!class_exists($this->controller)) {
        throw new \RuntimeException("Controller class '{$this->controller}' not found.");
    }

    $class = new $this->controller();

    if (!$class instanceof \CodeIgniter\Controller) {
        throw new \RuntimeException("Controller must be an instance of CodeIgniter\\Controller.");
    }
